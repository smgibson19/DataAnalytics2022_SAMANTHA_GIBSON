...
cChars <- c("*", "o", "+")[as.integer(iris$Species)]

# KMEANSRESULT is the variable you used in your k-means lab assignment for the return variable.
 a.cols <- rainbow(3)[KMEANSRESULT$cluster]

plot(iris.mds, col = a.cols, pch = cChars, xlab = "X", ylab = "Y")
